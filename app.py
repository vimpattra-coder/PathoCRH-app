...
# 2. จำลองข้อมูลสิ่งส่งตรวจและใช้ Session State บันทึกข้อมูล (เพิ่มเคสกำลังเก็บรักษาอีก 1 เคส)
if "df" not in st.session_state:
    data = {
        "เลขเคส (SN)": [
            ...
            "SN69-010"  # 👈 เพิ่มเคสที่กำลังเก็บรักษาเคสใหม่ตรงนี้
        ],
        "HN": [
            "1234567", "1234567", 
            "2345678", "3456789", 
            "5556667", "6667778", "7778889", "8889990", "9990001",
            "9990002"  # 👈 HN ของเคสใหม่
        ],
        "ชื่อผู้ป่วย": [
            ...
            "นางสมหญิง รักสงบ"  # 👈 ชื่อผู้ป่วยรายใหม่
        ],
        "วันที่ออกผลล่าสุด": [
            ...
            datetime.date(2026, 6, 2)  # 👈 เพิ่งออกผลล่าสุดเมื่อวานนี้ (นับไปอีก 15 วันจะยังไม่ครบกำหนดทิ้ง)
        ],
        "แพทย์เจ้าของเคส": ["VT", "VT", "NK", "KK", "PS", "NK", "VT", "PS", "KK", "NK"], # 👈 ให้คุณหมอ NK เป็นเจ้าของเคสใหม่
        "หมายเหตุ/เหตุผล": ["", "", "", "", "", "", "", "", "", ""],
...
# แปลงฟอร์แมตวันที่ให้อยู่ในรูปแบบที่ถูกต้อง
...
# 7. แสดงผลตารางหลักทั้งหมด
st.subheader("📋 รายการสิ่งส่งตรวจทั้งหมดในระบบ")
display_df = filtered_df[["เลขเคส (SN)", "HN", "ชื่อผู้ป่วย", "แพทย์เจ้าของเคส", "วันที่ออกผลล่าสุด", "กำหนดทิ้งสุดท้าย", "สถานะ", "หมายเหตุ/เหตุผล"]]
